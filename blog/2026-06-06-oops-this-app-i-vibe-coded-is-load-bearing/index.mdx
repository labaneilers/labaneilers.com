...
The really transformative possibilities are mostly around using AI to rapidly build prototypes that test hypotheses, prove out business opportunities, and demonstrate value- ahead of major investment. Armed with their domain expertise, non-technical folks can probably do a whole lot of exploration of a problem space, and converge on really substantial, well-vetted ideas.
