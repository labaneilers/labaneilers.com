...
:::tip[TL;DR]
This is a summary of the conversations I often have with perspective engineering managers about what I think life as an engineering manager looks like. We'll talk a bit about the high-level purpose of the role, and spend some time on the actual day-to-day work involved.
:::
...
## The gravity of engineering management

More than a decade ago, I went through a year-long manager training program, sponsored by my company, which was attempting to better systematize their management practice. At the time, I'd been managing already for a few years, and I thought I was pretty good at it. I was pretty skeptical about the program, especially given the time investment. But I stuck it out, and came out with a bunch of useful new tools which, even I had to admit, I ended up using- surprisingly often. 

A couple years later, [I had the opportunity to help lead a *much* larger team](/let-a-thousand-flowers-bloom). After years of marinating in the particularly touchy-feely varietal of management theory from my training program, the harsh reality of trying to get 200 engineers aligned towards a singular goal came crashing down on me... hard. This left me with a great deal of respect for the challenges of management, and appreciation for the people that dedicate themselves to the craft of it.
...
This point sometimes elicits doubt, so let me put this in even more stark terms: 
...
Yes, this is extraordinary fucked up, but it illustrates how extreme this dynamic is: in business, delivering value vastly outweighs every other concern.
...
Everyone involved was disappointed in this outcome (especially me), since she was well-liked and respected. But ultimately, accountability for business outcomes forced the decision.

## Everything you have to do in service of business outcomes
...
It's also really important to understand that this isn't a one-way flow of information. Effective managers also influence the decisions of their senior leadership, usually because they have visibility into details of the work on the ground- constraints, opportunities, tradeoffs- that senior leadership doesn't.
...
Because there's no "one size fits all" formula for building a system as complex as an engineering team, managers need to guide the team through a process of **continuous improvement**, in which you take a group of diverse and unique people, point them at a business need, and incrementally guide them towards higher performance over time. This means driving the process and culture to enable the team to repeatedly self-reflect on their work, identify areas for improvement, and implement them.

As the steward of this process, you need to establish two important things:
...
Luckily, there's a lot of great research on how to build psychological safety for teams. A great place to start is [Amy Edmondson's book, *The Fearless Organization*](https://www.hbs.edu/faculty/Pages/item.aspx?num=54851), or this shorter [Harvard Business Review article](https://hbr.org/2025/05/what-people-get-wrong-about-psychological-safety) that discusses misconceptions.
:::
...
The term "servant leadership" focuses on this aspect of management- the idea that a manager's job is to eliminate impediments to their team's success. Does your team need some new SaaS tool? Is UX constantly late delivering mockups? Are you blocked waiting on InfoSec to complete a security review? It's your job to make sure these obstacles get removed. 
...
Additionally, the galaxy brain manager will also recognize that certain patterns of blockers are *systemic*, and use their influence to address these through broader change, perhaps across multiple teams, or even at the organizational level.
...
* ceremonies: standups, planning, retrospectives, scrum-of-scrums
...
You'll likely also spend a lot of time creating and consuming written communication and documentation, which is a bit like a meeting, but a lot more durable in the long term.

To a new manager, especially one who was recently a high-performing individual contributor, this can seem wasteful- since meetings don't solve actual customer problems- which is true. But managers are necessary as an organization grows to serve as conduits of information; they maintain alignment and combat entropy. They make sure that teams aren't just working effectively, but that they're working on *the right things*.

You absolutely need to be careful about how you use meetings- they're a very expensive way to use people's time. But if you're using them carefully, running them quickly and efficiently, and you're actually achieving alignment and clarity, then it's not a waste of time.

### Staying connected to the work

Despite the pressures to constantly keep everyone aligned and make sure outcomes are being achieved, you need carve out time keep yourself connected to the actual work: customer needs, your teams' backlogs, your tech portfolio, industry trends, best practices, etc. This may take the form of doing some side projects, reviewing code, or even just listening to a ton of podcasts. 

:::warning be careful about being both player and coach
You may be tempted to jump in with your team and write code alongside them, but you need to be careful about the dynamics of this. Between the power imbalance making reviews weird, and conflicts between your primary role and the requirements of taking operational responsibility for one's own code, this can bit fraught.
:::
...
It's interesting that to get into engineering management, you generally have to have been a really successful individual contributor. Obviously, the skills involved very different, but the thing that caught me by surprise was the actual makeup of my day-to-day work.

Life as a manager is characterized by several things I actively sought to minimize as an IC: meetings, interruptions, and multitasking. As an IC, you generally seek to keep your work-in-progress to a minimum, and focus on getting a series of small, incremental things completely done. I never found a way to do this as a manager, since you have to be fairly reactive and attentive to the needs of everyone else around you. You're also responsible to handle lots of outside noise generated by teams that don't track (or care) how much WIP they're generating for you.

I found it much more draining from a social/emotional perspective, which was difficult given my tendency towards introversion. After a while, I found myself having a much harder time getting out of bed in the morning- in a way I never did when I was writing software every day.
