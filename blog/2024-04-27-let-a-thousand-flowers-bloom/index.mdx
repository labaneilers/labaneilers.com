...
We set up some initial organizational mechanisms to attempt to manage all this chaos, and make sure we maintained our ability to build features and products that made our customers happy. We found points of leverage across teams, elevated thoughtful and visionary people, and set up structures to help make sane architectural decisions.

## Then we watched the experiments unfold

Then, things got very interesting. We had something like 30 squads, each running themselves in almost any way they saw fit. There was a lot of diversity between teams; folks with different backgrounds, different technology preferences, stronger or weaker opinions, different seniority levels, etc. 
...
It's been a while since I left Vistaprint, and a there have been a few regime changes since then. It's my understanding that most of what we built (both organizational and software) was discarded in favor of replacements that were developed more incrementally (based on lessons learned).
