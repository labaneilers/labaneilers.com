...
Yes- we could be deriving these same metrics from logs or traces, but there's few remaining big factors, in practice, which it hard to imagine giving up traditional metrics entirely: 
