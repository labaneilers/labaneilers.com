...
My company, like many others, is exploring what it means to be able to empower non-technical employees with AI coding tools. There's a narrative pervading the zeitgeist that these tools give anyone the ability to vibe up real, working, load-bearing software systems.
...
Thinking through the absurdity of me using Claude to take over a function I'm utterly unqualified for made me think more deeply about what it would mean for non-technical vibe-coders to jump into my world- and start producing load-bearing software.
...
A non-technical user will be able to build some interesting things with agentic tools, but you probably don't want them building software that runs accounting systems, medical devices, or aircraft control systems.
...
For one, they can use AI to build prototypes that test hypotheses, prove out business opportunities, and demonstrate value. Armed with their domain expertise, they can probably do a whole lot of exploration of a problem space with a lot less need for assistance from expensive human engineers.
