...
For those of us who've actively chosen to be ICs, and have resisted the pressure to join management, it's important to remember that innovation is driven by *individuals*.
:::
...
But I want to push back a little on the idea that management is categorically more impactful than individual contribution. The concept is a bit of a tautology, because managers take credit for the innovation and impact of the individual contributors they hire. And because of the nature of software, a single person with the right idea, at the right time, can manifest that idea into the world to great effect- sometimes without any organization supporting them at all.

I'd like to tell you the story of the most impactful thing I've ever done, which was as an individual contributor. Even though though this was 18 years ago, I honestly don't know if I'll have another chance to do something quite like it.
...
:::info[Comparison]
There are now lots of apps that allow users to do really sophisticated design in the browser (e.g. Canva, Figma). We didn't have any of the browser technologies back then that make this possible today: the `canvas` tag, SVG, WebAssembly, WebGL, or even half-decent JavaScript engines.
...
Even so, I still occasionally catch myself dwelling pridefully on this achievement. It's hard to imagine an alternate universe where I never joined Vistaprint, where they tried to incrementally improve the old Studio architecture. I don't see how they could have had the success that they did in *this* universe; the difference might be measured in billions of dollars at this point.

I don't know how likely it is that I'll play such a pivotal role in building a multi-billion dollar company in the future.

## Innovation comes from individuals

Remembering this episode in my career has been useful to remind myself that impact, especially via innovation, is ultimately driven by individual contributors. This is really important to remember for those of us who've chosen to optimize our careers around the joy of being a technologist, especially when the social and financial pressures to advance our careers through management are so potent.
