...
description: Ask your doctor if Kubernetes may be right for you
...
import PepperTheDog from './pepper-on-couch.jpg';

<figure style={{width: 200, float: 'right', marginLeft: '20px'}} >
<img src={PepperTheDog} alt="Pepper the Dog"/>
<figcaption>Pepper and coffee</figcaption>
</figure>
