...
:::info[Why not Flash?]
In the weeks that followed, I had to address a lot of questions from folks about why I'd decided to use pure HTML/Javascript instead of Flash. It wasn't obvious at the time the Flash's days were numbered.
