...
In retrospect, I think that leadership's decision to push the tooling was its death knell. The platform team lost its incentive to win the trust of the developer teams, got caught up in their own vision, and built a beautiful product. It just didn't happen to be the product we needed.
