...
* **Software development**: TypeScript/JavaScript/node.js, Go, Python, C#/dotnet, Rust, shell scripting
...
I play two main roles at SimpliSafe; I'm part of the Engineering leadership team, and also a co-leader of our Platform Engineering team. Through both roles, I've been helping steer our Engineering culture towards empowerment, accountability, reliability, and innovation.
...
* Led the overhaul of our CI/CD systems, using Github Actions with private hosted runners on EKS, and Github OIDC to integrate with AWS IAM
